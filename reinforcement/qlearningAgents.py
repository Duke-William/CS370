...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        temp = reward + self.discount*self.getQValue(nextState, self.getPolicy(nextState))
        self.qvalues[(state, action)] = (1 - self.alpha)*self.getQValue(state, action) + self.alpha*temp
